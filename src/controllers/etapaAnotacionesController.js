...
const DIMENSIONES = {
    ...
    modoTerminacion: [
        ...
        "sustraccion_de_materia", "declaracion_de_abstraccion", "archivo", "incompetencia_con_remision", "incompetencia_sin_remision", "inhabilidad_de_instancia", "cosa_juzgada", "otro",
    ],
    ...
    actoProcesal: [
        ...
        "corre_traslado", "intima_pago_cita_remate", "cita_reconocimiento_firma", "cita_venta", "da_vista", "intima", "concede_prorroga", "difiere_proveimiento", "fija_audiencia", "celebra_audiencia", "ordena_notificacion", "ordena_oficio", "ordena_cedula",
        ...
        "registra_pago", "ordena_giro", "ordena_embargo", "ordena_medida_cautelar", "ordena_subasta", "ordena_lanzamiento", "declara_quiebra", "levanta_embargo", "suspende_proceso", "reanuda_proceso", "archiva", "otro",
    ],
    resultado: [
    ...
    accionRequerida: [
        ...
        "aceptar_cargo", "denunciar_datos_bancarios", "denunciar_datos_testigos", "prestar_caucion", "comparecer_audiencia", "diligenciar_cedula", "presentar_oficio", "integrar_copias", "integrar_copias_fisicas",
...
const ACTO_TIPICO = {
    ...
    cita_reconocimiento_firma: { tipoResolucion: "providencia_simple", materia: "fondo", funcion: "impulso", resultado: "no_aplica" },
    ...
    ordena_subasta: { tipoResolucion: "providencia_simple", materia: "ejecucion", contexto: "ejecucion", funcion: "decision", resultado: "hace_lugar" },
    ordena_lanzamiento: { tipoResolucion: "providencia_simple", materia: "ejecucion", contexto: "ejecucion", funcion: "decision", resultado: "hace_lugar" },
    declara_quiebra: { tipoResolucion: "sentencia_definitiva", materia: "fondo", funcion: "decision", resultado: "hace_lugar" },
